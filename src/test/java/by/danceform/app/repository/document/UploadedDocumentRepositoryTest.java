 ...
 */
public class UploadedDocumentRepositoryTest extends
    AbstractRepositoryTest<UploadedDocumentRepository, UploadedDocument, Long> {
    ...
    private static final ZonedDateTime EXISTING_UPLOADED_DATE = ZonedDateTime
        .of(2017, 2, 16, 12, 13, 14, 0, ZoneId.systemDefault());
