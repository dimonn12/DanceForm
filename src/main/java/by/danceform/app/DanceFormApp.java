...
public class DanceFormApp {
    ...
    /**
     * Initializes DanceForm. Spring profiles can be configured with a program arguments
     * --spring.profiles.active=your-active-profile You can find more information on how profiles work with JHipster on
